...
// File @openzeppelin/contracts-upgradeable/token/ERC20/ERC20Upgradeable.sol@v5.0.1
...
// File contracts/Dev/lib/SafeMath.sol
...
// File contracts/Dev/GroupMembership.sol
...
contract GroupMembership is Initializable, ERC721Upgradeable {
    ...
    modifier onlyFromSuperDapp(address allowedAddress) {
        require(
    ...
    ) public onlyFromSuperDapp(dappAddress) {
    ...
    function joinGroup(
        ...
        address owner
    ) public onlyFromSuperDapp(dappAddress) returns (uint256) {
    ...
    function calculateProfit(
        ...
        uint256 groupMultiplier = originalBondValue.mul(86).div(100);
    ...
    function groupLocked(uint256 groupId) public view returns (bool) {
        return groups[groupId].locked;
    }

    function getGroupSettingSnapshot(
        uint256 groupId
    ) public view returns (DappSettingSnapshot memory) {
    ...
    function setMinimumJoinAmount(
        ...
        uint256 minimumJoinAmount,
        address sender
    ) public onlyFromSuperDapp(dappAddress) returns (uint256, uint256) {
        Group storage group = groups[groupId];
        require(
    ...
    function transferOwnership(uint256 groupId, address newOwner) public {
...
// File contracts/Dev/SuperDapp.sol
...
contract SuperDapp is Initializable, OwnableUpgradeable {
    using SafeMath for uint256;
    ...
    function createGroup(
        ...
        groupMembership.createGroup(
            ...
            groupType,
            msg.sender,
            80, // originalBondValueMultiplier = 80%
    ...
    ) public returns (uint256[] memory, uint256[] memory, uint256[] memory) {
...
// File contracts/Dev/SuperDappToken.sol
...
contract GroupMembership is Initializable, ERC721Upgradeable {
    ...
    function joinGroup(
        ...
        uint256 bondPriceMinusFee,
        address owner
    ) public onlyFromSuperDapp returns (uint256) {
        Group storage group = groups[groupId];
        require(
            originalBondPrice >= group.minimumJoinAmount,
            "Insufficient group payment"
    ...
    function leaveGroup(
        ...
        uint256 tokenId,
        address owner
    ) public onlyFromSuperDapp returns (uint256, uint256, uint256) {
        require(
            ownerOf(tokenId) == owner,
            "You are not a member of this group"
        );
    ...
    function setMinimumJoinAmount(
        ...
        uint256 minimumJoinAmount,
        address sender
    ) public onlyFromSuperDapp returns (uint256, uint256) {
        Group storage group = groups[groupId];
        require(
            group.creator == sender,
            "Only group creator can set minimum join amount"
...
contract SuperDapp is Initializable, OwnableUpgradeable {
    ...
    function createGroup(
        ...
        groupMembership.createGroup(
            ...
            groupType,
            msg.sender,
            86, // originalBondValueMultiplier = 80%
            40, // groupFeeAmount = 40%
            GroupMembership.DappSettingSnapshot(
                protocolFeePercent,
                subjectFeePercent
